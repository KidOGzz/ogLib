...
public final class FallTracker implements Listener {
    ...
    public static class FallDamageByPlayer extends PlayerDamage {
        ...
        public String getDeathMessage(UUID getFor) {
            return FallDamageByPlayer.wrapName(this.getDamaged(), getFor) + ChatColor.YELLOW + " hit the ground too hard thanks to " + FallDamageByPlayer.wrapName(this.getDamager(), getFor) + ChatColor.YELLOW + ".";
        }
    }
