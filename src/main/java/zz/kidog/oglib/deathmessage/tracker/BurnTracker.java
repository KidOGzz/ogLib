...
public final class BurnTracker implements Listener {
    ...
    public static class BurnDamageByPlayer extends PlayerDamage {
        ...
        public String getDeathMessage(UUID getFor) {
            return BurnDamageByPlayer.wrapName(this.getDamaged(), getFor) + ChatColor.YELLOW + " burned to death thanks to " + BurnDamageByPlayer.wrapName(this.getDamager(), getFor) + ChatColor.YELLOW + ".";
        }
    }
