package zz.kidog.oglib.serialization;
...
public class PlayerInventorySerializer {
    ...
    public static String serialize(Player player) {
        return ogLib.PLAIN_GSON.toJson(new PlayerInventoryWrapper(player));
    }

    public static PlayerInventoryWrapper deserialize(String json) {
        return ogLib.PLAIN_GSON.fromJson(json, PlayerInventoryWrapper.class);
    }
