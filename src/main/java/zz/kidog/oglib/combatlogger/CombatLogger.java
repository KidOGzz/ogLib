...
public class CombatLogger {
    ...
    public static final String COMBAT_LOGGER_METADATA = "ogLib-CombatLogger";
    ...
    public LivingEntity spawn(Location location) {
        ...
        entity.setMetadata(COMBAT_LOGGER_METADATA, new FixedMetadataValue(ogLib.getInstance(), "001100010010011110100001"));
        ...
        }.runTaskLater(ogLib.getInstance(), this.despawnTime * 20L);
